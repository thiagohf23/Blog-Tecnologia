<x-app-layout>
    @section('hero')
        <div class="w-full text-center py-32">
            <h1 class="text-2xl md:text-3xl font-bold text-center lg:text-5xl text-gray-700">
                Welcome to <span class="text-yellow-500">&lt;Talking&gt;</span> <span class="text-gray-900"> Devs</span>
            </h1>
    ...
    <div class="mb-10 w-full">
        ...
        <a class="mt-10 block text-center text-lg text-yellow-500 font-semibold" href="http://localhost">More
            Posts</a>
    </div>
</x-app-layout>
